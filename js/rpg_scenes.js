...
Scene_Battle.prototype.onButtonEnd = function() {
	var max = 4;
	while($gameParty._Gcards.length > max){
		$gameParty.useRandomCards();
	}
...
Scene_Battle.prototype.createSkillWindow = function() {
	...
	var bitmap = ImageManager.loadSystem('end');
	var button = new Sprite_Button();
	button.bitmap = bitmap;
	button.setColdFrame(0, 0, 144, 32);
	button.setHotFrame(0, 32, 144, 32);
	button.x = 1100;
	button.y = 200;	
    this._skillWindow = new Window_BattleSkill(0, wy, Graphics.boxWidth, wh);
	this._skillWindow.addChild(button);
	button.setClickHandler(this.onButtonEnd.bind(this));	
...
Scene_Battle.prototype.selectNextCommand = function() {
	...
	BattleManager.actor().gainMp(100)
	$gameParty.randomCards();
    this.changeInputWindow();
};
...
Scene_Battle.prototype.onActorOk = function() {
	...
	var ic = this._skillWindow.index();
	$gameParty.useCards(ic)	
    this.selectNextCommand();
};
